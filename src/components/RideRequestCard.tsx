            ...
            <div className="text-sm p-2 rounded bg-purple-50 border border-purple-200">
              ...
              <div className="mt-1 text-purple-600">
                {priceInfo.discountPercentage ? (
                  <div>
                    <div className="flex items-center gap-2">
                      <span className="line-through text-gray-500">市场价: {priceInfo.originalPrice} {request.payment_currency}</span>
                      <Badge variant="outline" className="bg-green-100 text-green-700 text-xs">
                        {priceInfo.discountPercentage}% 折扣
                      </Badge>
                    </div>
                    <div className="font-semibold">
                      感谢费: {priceInfo.amount.toFixed(2)} {request.payment_currency}
                    </div>
                  </div>
                ) : (
