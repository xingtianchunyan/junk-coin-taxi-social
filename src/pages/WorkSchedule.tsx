        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent>
            ...
            {selectedRoute && <div className="space-y-4">
              ...
              const routeRequests = rideRequests.filter(request => request.start_location === selectedRouteData?.start_location && request.end_location === selectedRouteData?.end_location);
              ...
              return <div>
                      ...
                      <div className="space-y-3">
                        {routeRequests.map((request, index) => <div key={request.id} className="flex items-center gap-4 p-4 border rounded-lg">
            ...
            {!selectedRoute && <div className="text-center py-8">
                <Car className="h-16 w-16 text-gray-300 mx-auto mb-4" />
